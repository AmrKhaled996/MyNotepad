                    ...
                    child: Align(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(  //--------------------container contains the tasks---------------
                              ...
                              // child: Expanded(
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (context, i) {
                                      return Row(children: [
                                        Checkbox(
                                          value: TODOLists[index]
                                              .tasks[i]
                                              .completed,
                                          activeColor: Colors.blue[400],
                                          onChanged: (bool? value) {
                                            setState(() {
                                              TODOLists[index].tasks[i].completed = value!;
                                              ReloadTasks();
                                            });
                                          },
                                        ),
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          Share.share(_formatTaskListForSharing(TODOLists[index]),
